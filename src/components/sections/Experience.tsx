      ...
      <div className="container-x">
        ...
        <ol className="flex flex-col">
          {EXPERIENCE.map((exp, i) => (
            <li
              key={exp.id}
              className="group grid grid-cols-1 gap-6 border-t border-[var(--color-border)] py-10 transition-colors hover:bg-white/[0.015] md:grid-cols-12 md:gap-10"
            >
              ...
              <div className="md:col-span-5">
                <h3 className="font-serif text-[clamp(22px,2.4vw,36px)] leading-tight transition-colors group-hover:text-[var(--color-accent)]">
                  {exp.company}
                </h3>
