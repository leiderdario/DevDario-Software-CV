...
export const DICT: Dict = {
  ...
  // Hero
  'hero.eyebrow': { es: 'Disponible para proyectos · 2026', en: 'Open for work · 2026' },
  'hero.title.line1': { es: 'Ingeniero de software', en: 'Software engineer' },
  ...
  // Services
  'services.eyebrow': { es: 'Esto es lo que entrego.', en: 'This is what I ship.' },
  'services.title': { es: 'Servicios.', en: 'Services.' },
  'services.lead': {
    es: 'Trabajo de punta a punta: arquitectura, código, despliegue y handoff. Sin intermediarios.',
    en: 'I work end to end: architecture, code, deployment, handoff. No middlemen.',
  },

  // Toolbox
  'toolbox.eyebrow': { es: 'Con qué construyo', en: 'What I build with' },
  'toolbox.title': { es: 'Toolbox.', en: 'Toolbox.' },
  'toolbox.lead': {
    es: 'Herramientas que uso a diario. Ninguna por moda — todas porque resuelven.',
    en: 'Tools I reach for daily. None for hype — all because they solve something.',
  },

  // Trusted
  'trusted.eyebrow': { es: 'Confían en mi trabajo', en: 'Trusted by' },
  'trusted.title': { es: 'Instituciones y equipos.', en: 'Institutions & teams.' },

  // Work
  'work.eyebrow': { es: 'Casos seleccionados', en: 'Selected cases' },
  'work.title': { es: 'Proyectos.', en: 'Selected work.' },
  'work.lead': {
    es: 'IA aplicada, plataformas de gobierno, EdTech y herramientas internas. Cosas que corren.',
    en: 'Applied AI, government platforms, EdTech, and internal tools. Things that run.',
  },
  ...
  'statement.title': {
    ...
    en: 'I build software that learns, scales, and reports numbers — not pretty demos.',
  },
  ...
  // Testimonials
  'testimonials.eyebrow': { es: 'Lo que dicen los que me contrataron.', en: 'What the people who hired me say.' },
  ...
  'studio.lead': {
    es: 'Estudio que cofundé en 2026. Construimos software para industria, plataformas y gaming.',
    en: 'A studio I co-founded in 2026. We build software for industry, platforms, and gaming.',
  },
  ...
  'cursor.play': { es: 'Play', en: 'Play' },
  'cursor.drag': { es: 'Arrastra', en: 'Drag' },
  'cursor.copy': { es: 'Copiar', en: 'Copy' },
